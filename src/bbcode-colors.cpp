// =========================================================================
// SUP BBCode Text — Named colors (140+ Godot/X11 named colors)
// =========================================================================
...
uint32_t lookup_named_color(const std::string &name)
{
    static const std::map<std::string, uint32_t> colors = {
        ...
        {"darkgreen",          0x006400}, {"darkkhaki",          0xBDB76B},
        ...
        {"goldenrod",          0xDAA520}, {"gray",               0xBEBEBE},
        {"grey",               0xBEBEBE}, {"green",              0x00FF00},
        ...
        {"lightgoldenrod",     0xFAFAD2}, {"lightgray",          0xD3D3D3},
        {"lightgrey",          0xD3D3D3}, {"lightgreen",         0x90EE90},
        ...
        {"maroon",             0xB03060}, {"mediumaquamarine",   0x66CDAA},
        ...
        {"navyblue",           0x000080}, {"oldlace",            0xFDF5E6},
        {"olive",              0x808000}, {"olivedrab",          0x6B8E23},
        {"orange",             0xFFA500}, {"orangered",          0xFF4500},
        {"orchid",             0xDA70D6}, {"palegoldenrod",      0xEEE8AA},
        {"palegreen",          0x98FB98}, {"paleturquoise",      0xAFEEEE},
        {"palevioletred",      0xDB7093}, {"papayawhip",         0xFFEFD5},
        {"peachpuff",          0xFFDAB9}, {"peru",               0xCD853F},
        {"pink",               0xFFC0CB}, {"plum",               0xDDA0DD},
        {"powderblue",         0xB0E0E6}, {"purple",             0xA020F0},
        {"rebeccapurple",      0x663399}, {"red",                0xFF0000},
        ...
        {"slategrey",          0x708090}, {"snow",               0xFFFAFA},
        {"springgreen",        0x00FF7F}, {"steelblue",          0x4682B4},
        {"tan",                0xD2B48C}, {"teal",               0x008080},
        {"thistle",            0xD8BFD8}, {"tomato",             0xFF6347},
        {"turquoise",          0x40E0D0}, {"violet",             0xEE82EE},
        {"webgray",            0x808080}, {"webgrey",            0x808080},
        {"webgreen",           0x008000}, {"webmaroon",          0x800000},
        {"webpurple",          0x800080}, {"wheat",              0xF5DEB3},
    ...
    it = colors.find(stripped);
    return (it != colors.end()) ? it->second : 0xFFFFFF;
}
...
uint32_t hsv_to_rgb(float h, float s_val, float v)
{
    ...
    uint8_t ir = (uint8_t)((r + m) * 255.0f);
    uint8_t ig = (uint8_t)((g + m) * 255.0f);
    uint8_t ib = (uint8_t)((b + m) * 255.0f);
